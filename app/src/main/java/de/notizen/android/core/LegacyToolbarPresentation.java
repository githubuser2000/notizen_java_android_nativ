...
public final class LegacyToolbarPresentation {
    ...
    static {
        ...
        put(m, "Rückgängig", "undo", "Rückgängig", "↶", "Ctrl+Z", "font");
        put(m, "Wiederholen", "redo", "Wiederholen", "↷", "Ctrl+Y", "font");
        ...
        put(m, "Durchgestrichen", "format_strike", "Durchstreichen", "S̶", "", "font");
        put(m, "Textfarbe", "text_color", "RTF-Textfarbe", "■", "", "font");
        put(m, "Hintergrund", "highlight_color", "RTF-Hintergrundfarbe", "▣", "", "font");
        put(m, "Links", "align_left", "Linksbündig", "☰", "", "font");
        put(m, "Mitte", "align_center", "Zentriert", "≡", "", "font");
        put(m, "Rechts", "align_right", "Rechtsbündig", "☷", "", "font");
        put(m, "Blocksatz", "align_justify", "Blocksatz", "▤", "", "font");
